...
print("--- Configurando logs a nivel DEBUG ---")
# configure_logging(logging.DEBUG)

print("--- Ejecutando ejemplo de xycutppy ---")
...
print(f"Definidos {len(elements)} elementos para ordenar.")
...
print(f"Límites de la página: {page_bounds}")
...
print("Orden de lectura de los IDs (default config):")
for element_id in ordered_ids_default:
    print(f"  -> Leer elemento {element_id}")
...
ordered_ids_custom = compute_order(elements, page_bounds, config=custom_config)

print("Orden de lectura de los IDs (custom config):")
